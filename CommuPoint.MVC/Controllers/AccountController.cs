...
using CommuPoint.Core.Application.ViewModels;
...
using CommuPoint.Common.Helpers;
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> EditAccount(EditVM editVM)
        {
            ...
            if (editVM.ProfileImage != null)
            {
                ...
                string fileName = await CommuPoint.Common.Helpers.Extensions.CreateImage(editVM.ProfileImage, _environment.WebRootPath, "UserImage");
            ...
            if (editVM.BannerImage != null)
            {
                ...
                string fileName = await CommuPoint.Common.Helpers.Extensions.CreateImage(editVM.BannerImage, _environment.WebRootPath, "UserImage");
